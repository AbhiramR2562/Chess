...
class _GameBoardState extends State<GameBoard> {
  ...
  void _initializeBoard() {
    ...
    //   isWhite: false,
    //   imagePath: 'assets/images/black_chess_king_icon.png',
    // );
    ...
    for (int i = 0; i < 8; i++) {
      newBoard[1][i] = ChessPiece(
        ...
        isWhite: false,
        imagePath: 'assets/images/black_chess_pawn_icon.png',
      );
    ...
    newBoard[0][0] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'assets/images/black_chess_rook_icon.png',
    );
    ...
    newBoard[0][1] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'assets/images/black_chess_knight_icon.png',
    );
    ...
    newBoard[0][2] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'assets/images/black_chess_bishop_icon.png',
    );
    ...
    newBoard[0][3] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'assets/images/black_chess_queen_icon.png',
    );
